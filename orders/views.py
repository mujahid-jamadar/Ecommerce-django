...
def payments(request):
    ...
    # move cart item to order product and
    ...
    # send user recieved email to cumtomer
    ...
    # order number and transaction details back to thanks page(send data via JsonResponse)
    data={
...
def place_order(request,total=0,quantity=0):
    ...
    # if cart count is less than 1 redirect to shop
